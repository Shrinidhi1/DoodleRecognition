...
cv.createTrackbar("Hue Max", "TrackBars", 153, 180, func)
cv.createTrackbar("Sat Max", "TrackBars", 255, 255, func)
cv.createTrackbar("Val Max", "TrackBars", 255, 255, func)
cv.createTrackbar("Hue Min", "TrackBars", 64, 180, func)
cv.createTrackbar("Sat Min", "TrackBars", 72, 255, func)
cv.createTrackbar("Val Min", "TrackBars", 49, 255, func)
